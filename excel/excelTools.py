...
# newpath = os.chdir(r'D:python_pycharmWorkspacepython36Interface_Test_Training est_caseexcel_train')

filename = "选择用户和选择文件.xlsx"
...
print(xl.sheet_by_name('Sheet1'))  # 通过名称获取
